...
var http = {
    ...
    sendRequest: function(url, options, success, failure) {
        if (options.method === 'get') {
            return this.get(url, options.params || {}, options.headers || {}, success, failure)
        } else if (options.method === 'post') {
            return this.post(url, options.data || {}, options.headers || {}, success, failure)
        } else {
            failure('sendRequest error! method:' + options.method)
        }
    },
